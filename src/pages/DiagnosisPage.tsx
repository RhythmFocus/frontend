...
const DIAGNOSIS_LIST: DiagnosisItem[] = [
    ...
    { id: '7', type: 'STROOP', title: 'Stroop Test', category: '집중력', categoryColor: '#ff6b6b', inputMethod: 'MOUSE', status: 'NOT_STARTED', grade: null, description: '마우스 사용' }, // 테스트용 중복
];
...
function DiagnosisPage() {
    ...
    const handleCardClick = (item: DiagnosisItem) => {
        ...
        } else if (item.type === 'CFQ') {
            navigate('/cfq', { state: { gameType: item.type } });
